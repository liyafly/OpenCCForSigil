...
The engineering specification, maintainer testing guidance, and release notes
are source-controlled under `docs/`; they are not generated into a documentation
ZIP. The installable plugin includes a focused user guide at
`OpenCCForSigil/resources/rule-guide.md` and links to it from its root
`README.md`.
