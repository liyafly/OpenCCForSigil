...
Python Binding smoke tests, and the independent official CLI differential
corpus on its own native runner. It then exports only the target-tested payload
