...
| Asset | Use it when |
| --- | --- |
| `OpenCCForSigil_<version>.zip` | Fat Plugin for the five CPython 3.14/cp314 runtimes. |
...
| `OpenCCForSigil_<version>_linux-x86_64.zip` | Sigil runs CPython 3.14/cp314 and `uname -m` reports `x86_64`. |
| `OpenCCForSigil_<version>_linux-x86_64-cp312.zip` | Linux x86_64 Sigil runs CPython 3.12/cp312, including Ubuntu 24.04's packaged Sigil. |
| `OpenCCForSigil_<version>_linux-aarch64.zip` | Sigil runs CPython 3.14/cp314 and `uname -m` reports `aarch64`. |
