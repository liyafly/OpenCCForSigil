...
| Asset | Use it when |
| --- | --- |
| [OpenCCForSigil_0.2.2.zip](https://github.com/liyafly/OpenCCForSigil/releases/download/v0.2.2/OpenCCForSigil_0.2.2.zip) | Fat Plugin for the five CPython 3.14/cp314 runtimes. |
| [OpenCCForSigil_0.2.2_macos-arm64.zip](https://github.com/liyafly/OpenCCForSigil/releases/download/v0.2.2/OpenCCForSigil_0.2.2_macos-arm64.zip) | Sigil runs as Apple Silicon. |
| [OpenCCForSigil_0.2.2_macos-x86_64.zip](https://github.com/liyafly/OpenCCForSigil/releases/download/v0.2.2/OpenCCForSigil_0.2.2_macos-x86_64.zip) | Sigil runs as Intel, including under Rosetta. |
| [OpenCCForSigil_0.2.2_windows-x86_64.zip](https://github.com/liyafly/OpenCCForSigil/releases/download/v0.2.2/OpenCCForSigil_0.2.2_windows-x86_64.zip) | Sigil runs as Windows x64. |
| [OpenCCForSigil_0.2.2_linux-x86_64.zip](https://github.com/liyafly/OpenCCForSigil/releases/download/v0.2.2/OpenCCForSigil_0.2.2_linux-x86_64.zip) | Sigil runs CPython 3.14/cp314 and `uname -m` reports `x86_64`. |
| [OpenCCForSigil_0.2.2_linux-x86_64-cp312.zip](https://github.com/liyafly/OpenCCForSigil/releases/download/v0.2.2/OpenCCForSigil_0.2.2_linux-x86_64-cp312.zip) | Linux x86_64 Sigil runs CPython 3.12/cp312, including Ubuntu 24.04's packaged Sigil. |
| [OpenCCForSigil_0.2.2_linux-aarch64.zip](https://github.com/liyafly/OpenCCForSigil/releases/download/v0.2.2/OpenCCForSigil_0.2.2_linux-aarch64.zip) | Sigil runs CPython 3.14/cp314 and `uname -m` reports `aarch64`. |
| [SHA256SUMS.txt](https://github.com/liyafly/OpenCCForSigil/releases/download/v0.2.2/SHA256SUMS.txt) | SHA-256 digest list for all seven ZIPs. |
